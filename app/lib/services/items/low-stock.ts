...
// otherwise fall back to the item's fixed min_stock floor. A min_stock
// of 0 is a deliberate "don't track this as low stock" opt-out (e.g. a
// discontinued or off-menu item) — it should never trigger a reorder
// suggestion on its own, even at quantity 0.
